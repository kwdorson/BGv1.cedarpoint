class VirtualShops {
    class market {
        ...
        side = "civ";
        conditions = "";
        items[] = { "storagesmall", "storagebig", "bandage", "morphine", "protest", "flashlight", "campfire", "cprKit", "axe", "timber", "pdrill", "pickaxe", "toolkit", "fuelFull", "peach", "cloth", "goldcoin", "waterBottle", "apple", "pepsi", "cocaCola", "monsterEnergy", "doritos", "shittynoodles", "kfc", "easterEggs", "beer_processed", "whiskey", "moonshine", "redgull", "tbacon", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw", "sugar_processed", "rice_processed" };
    };
    ...
    class med_market {
        ...
        side = "med";
        conditions = "";
        items[] = { "bandage", "morphine", "flashlight", "waterBottle", "rabbit", "apple", "redgull", "tbacon", "toolkit", "fuelFull", "peach", "cprKit" };
    };
    ...
    class blackmarket {
        ...
        items[] = { "cyanideCapsule", "morphine", "speedbomb", "gpstracker", "flashlight", "barrel", "butt", "zipties", "pliers", "blindfold", "codeCracker", "bandage", "cprKit", "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge", "demolitioncharge" };
    };
    ...
    class raven {
        ...
        side = "civ";
        conditions = "";
        items[] = { "bandage", "protest", "flashlight", "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge", "demolitioncharge" };
    };
    ...
    class f_station_coffee {
        ...
        side = "";
        conditions = "";
        items[] = { "coffee", "donuts", "redgull", "bandage", "morphine", "toolkit", "fuelFull"};
    };
    ...
    class cop {
        ...
        side = "cop";
        conditions = "";
        items[] = { "panicbutton", "handcuffs", "keys", "morphine", "bandage", "cprKit", "dogwhistle", "gpstracker", "flashlight", "fueldart", "donuts", "coffee", "spikeStrip", "waterBottle", "rabbit", "apple", "redgull", "toolkit", "fuelFull", "defusekit" };
    };
    ...
    class archeologist {
        ...
        side = "civ";
        conditions = "(missionNamespace getVariable ['mav_ttm_var_relicReward3', 0]) isEqualTo 1;";
        items[] = {"excavator" };
    };
...
class VirtualItems {
    ...
    //alchohol
    class beer_processed {
		variable = "beer_processed";
    ...
    class keys {
        ...
        illegal = false;
        edible = -1;
        icon = "images\icons\icon_keys.paa";
    };
    ...
    class morphine {
        ...
        illegal = false;
        edible = -1;
        icon = "images\icons\ico_morphine.paa";
    };
	...
	class sugar_unprocessed {
        ...
        edible = -1;
        icon = "";
        processedItem = "sugar_processed";
    };

    class sugar_processed {
        variable = "sugarProcessed";
        displayName = "STR_Item_SugarP";
        weight = 1;
        buyPrice = -1;
        sellPrice = 280;
        illegal = false;
	...
	class rice_unprocessed {
        variable = "riceUnprocessed";
        ...
        edible = -1;
        icon = "";
        processedItem = "rice_processed";
    };

    class rice_processed {
        variable = "riceProcessed";
	...
	class ecstacy {
        ...
        edible = -1;
        icon = "images\icons\ico_marijuana.paa";
        description = "Illegal run. Requires chemical barrels.";
    };
