...
class The_Programmer_Iphone_Cell_Menu {
   ...
   movingenable = 0;
   enablesimulation = 1;
   onload = "[] spawn the_programmer_iphone_fnc_messagemenu";
   ...
   class controls
   {
       ...
       class TextAdminButton : Life_RscButtonInvisible
       {
           idc = -1;
           text = "";
       ...
       class oldmessages : Life_RscButtonInvisible
       {
           text = "";
       ...
       class sendMSG : Life_RscButtonInvisible
       {
           text = "";
       ...
       class Contacts : Life_RscButtonInvisible
       {
           text = "";
           onbuttonclick = "[1] spawn the_programmer_iphone_fnc_contactmenu;";
