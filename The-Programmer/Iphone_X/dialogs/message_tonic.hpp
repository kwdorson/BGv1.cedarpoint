...
class The_Programmer_Iphone_Cell_TONIC_Menu {
   ...
   movingenable = 0;
   enablesimulation = 1;
   onload = "[] spawn the_programmer_iphone_fnc_message";
   ...
   class controls
   {
       ...
       class Envoyer : Life_RscButtonInvisible
       {
           idc = 3015;
       ...
       class Police : Life_RscButtonInvisible
       {
           idc = 3016;
       ...
       class Pompier : Life_RscButtonInvisible
       {
           idc = 3022;
