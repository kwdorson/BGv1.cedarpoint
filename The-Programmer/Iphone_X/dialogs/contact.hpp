...
class The_Programmer_Iphone_Contact_Menu {
   ...
   class controls
   {
       ...
       class AddContact : Life_RscButtonInvisible
       {
           idc = 4615;
           text = "";
       ...
       class RemoveContact : Life_RscButtonInvisible
       {
           text = "";
           idc = 4406;
           onbuttonclick = "[(lbCurSel 3005)] call the_programmer_iphone_fnc_removeContact;";
       ...
       class Resetcontact : Life_RscButtonInvisible
       {
           text = "";
           idc = 6501;
