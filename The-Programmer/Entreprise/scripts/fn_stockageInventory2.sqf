...
(_display displayCtrl 9744) ctrlSetText format [(["STR_STOCKAGE_TOTAL"] call max_entreprise_fnc_localize),_nowStock,(_entreprise getVariable ["entreprise_maxstock_2",0])];

_entrepriseInv = CONTROL(9740,9745);
_playerInv = CONTROL(9740,9746);
