...
if (_oldEntACC < _amount) exitWith {hint (["STR_NOT_ENOUGHT_MONEY_ENTREPRISE_ACC"] call max_entreprise_fnc_localize)};
...
hint format [(["STR_TRANSFERT_FROM_ENTACC_SUCCES"] call max_entreprise_fnc_localize),[_amount] call life_fnc_numberText];
