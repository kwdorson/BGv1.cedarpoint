...
if (life_fishFinder < _value) exitWith {hint (["STR_NOT_ENOUGHT_MONEY"] call max_gouvernement_fnc_localize);};
...
[maxence_compte_gouv,maxence_compte_cop,maxence_compte_med,(name player),3,_type,_value,0] remoteExec ["max_gouvernement_fnc_updateAccounts",2];

_fromTXT = (["STR_PERSONNAL_ACCOUNT"] call max_gouvernement_fnc_localize);
_toTXT = switch (_type) do {
