/*
    ...
    Owner's name:
*/
class maxence_gouverneur {
   idd = 1600;
   name = "maxence_gouverneur";
   movingenable = 0;
   enablesimulation = 1;
   ...
   class controls
   {
       ...
       class emploiministre : Life_RscButtonMenu
       {
           colorbackground[] = {1,1,1,0};
           ...
           y = 0.540806293018682 * safezoneH + safezoneY;
           w = 0.0895833333333333 * safezoneW;
           h = 0.0284575575221239 * safezoneH;
           idc = -1;
           onbuttonclick = "[1] spawn max_gouvernement_fnc_sendInviteGouvernement;";
           text = "";
       };
       class exclureministre : Life_RscButtonMenu
       {
           colorbackground[] = {1,1,1,0};
           colorbackgroundfocused[] = {1,1,1,0};
           colorbackground2[] = {1,1,1,0};
           ...
           y = 0.669616519174041 * safezoneH + safezoneY;
           w = 0.0895833333333333 * safezoneW;
           h = 0.0284575575221239 * safezoneH;
           idc = -1;
           onbuttonclick = "[1] spawn max_gouvernement_fnc_gouvernementKick;";
           text = "";
       };
       class employersecurite : Life_RscButtonMenu
       {
           colorbackground[] = {1,1,1,0};
           colorbackgroundfocused[] = {1,1,1,0};
           colorbackground2[] = {1,1,1,0};
           ...
           y = 0.54086397640118 * safezoneH + safezoneY;
           w = 0.0895833333333333 * safezoneW;
           h = 0.0284575575221239 * safezoneH;
           idc = -1;
           text = "";
           onbuttonclick = "[2] spawn max_gouvernement_fnc_sendInviteGouvernement;";
       };
       class excluresecurite : Life_RscButtonMenu
       {
           colorbackground[] = {1,1,1,0};
           colorbackgroundfocused[] = {1,1,1,0};
           colorbackground2[] = {1,1,1,0};
           ...
           tooltipcolorbox[] = {1,1,1,0};
           tooltipcolorshade[] = {1,1,1,0};
           x = 0.4578125 * safezoneW + safezoneX;
           y = 0.669153718780728 * safezoneH + safezoneY;
           w = 0.0895833333333333 * safezoneW;
           h = 0.0284575575221239 * safezoneH;
           idc = -1;
           onbuttonclick = "[2] spawn max_gouvernement_fnc_gouvernementKick;";
           text = "";
       };
       class listeministres : Life_RscListBox
       {
           ...
           w = 0.122916666666667 * safezoneW;
           h = 0.0914454277286136 * safezoneH;
           idc = 1011;
           colortext[] = {0,0,0,1};
           sizeex = 0.043;
           colorshadow[] = {1,1,1,0};
       ...
       class listesecurites : Life_RscListBox
       {
           ...
           y = 0.574237954768928 * safezoneH + safezoneY;
           w = 0.126302083333333 * safezoneW;
           h = 0.0894788593903638 * safezoneH;
           idc = 1012;
           colortext[] = {0,0,0,1};
           sizeex = 0.043;
           colorshadow[] = {1,1,1,0};
       ...
       class demissioner : Life_RscButtonMenu
       {
           ...
           h = 0.0284575575221239 * safezoneH;
           idc = -1;
           onbuttonclick = "[] spawn max_gouvernement_fnc_disbandGouvernement;";
           text = "";
       };
       ...
       {
           idc = 1018;
           x = 0.578645833333333 * safezoneW + safezoneX;
           y = 0.570304818092429 * safezoneH + safezoneY;
           h = 0.026366273352999 * safezoneH;
       ...
       class listeministre : Life_RscCombo
       {
           x = 0.303541666666667 * safezoneW + safezoneX;
           y = 0.504607177974435 * safezoneH + safezoneY;
           w = 0.113541666666667 * safezoneW;
           h = 0.0292994100294985 * safezoneH;
           idc = 1021;
           colorselect[] = {0,0,0,1};
           colortext[] = {0,0,0,1};
       ...
       class listesecurite : Life_RscCombo
       {
