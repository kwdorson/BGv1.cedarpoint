...

{
	...
	{
		_text = format["%1<img size='2' image='images\icons\trendup.paa'/> %2 $ <br/>", _text, _globalchange];
	}
	else
	{
		_text = format["%1<img size='2' image='images\icons\trenddown.paa'/> %2 $ <br/>", _text, _globalchange];
	};
