...
if ((missionNamespace getVariable ['mav_ttm_var_hideBody', 0]) isEqualTo 0) exitwith {["You need to learn how to dismantle bodies first!",true,"slow"] call life_fnc_notificationSystem;}; 
