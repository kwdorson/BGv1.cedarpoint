...
/*
    ...
    Blah blah.
*/
private _cedarpointArray = ["Land_House_Small_02_V1_ruins_F","Land_House_Small_02_V1_ruins_F"];
private _tanoaArray = ["Land_School_01_F","Land_Warehouse_03_F","Land_House_Small_02_F"];

private _hideoutObjs = [[["Cedarpoint", _cedarpointArray], ["Tanoa", _tanoaArray]]] call TON_fnc_terrainSort;
