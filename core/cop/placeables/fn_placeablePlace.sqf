...
if (count life_bar_placey >= life_bar_limit) exitWith {["You've reached the limit of objects you can place.",false,"fast"] call life_fnc_notificationSystem;}; // hint "You've reached the limit of objects you can place."; 
