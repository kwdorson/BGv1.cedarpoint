...
if ((missionNamespace getVariable ['mav_ttm_var_relicReward', 0]) isEqualTo 1) exitwith {["You have already completed this quest!",true,"slow"] call life_fnc_notificationSystem;}; 
