...
if ((missionNamespace getVariable ['mav_ttm_var_relicReward', 0]) isEqualTo 0) exitwith {["You need to complete the first quest before completing this!",true,"slow"] call life_fnc_notificationSystem;}; 
if ((missionNamespace getVariable ['mav_ttm_var_relicReward2', 0]) isEqualTo 0) exitwith {["You need to complete the second quest before completing this!",true,"slow"] call life_fnc_notificationSystem;}; 
if ((missionNamespace getVariable ['mav_ttm_var_relicReward3', 0]) isEqualTo 1) exitwith {["You have already completed this quest!",true,"slow"] call life_fnc_notificationSystem;}; 
